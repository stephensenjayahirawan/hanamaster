<section id="market" class="portfolio">
	<div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-12 d-flex justify-content-center">
                <ul class="portfolio-flters" id="portfolio-flters-market">
                    <li data-filter=".filter-medical-equipment" class="filter-active">Medical Equipment</li>
        ...
        <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-item filter-medical-equipment">
                <h3 style="margin-bottom: 25px">Medical Equipment</h3>
                <div  class="about">
        ...
        <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-item filter-automotive">
        ...
        <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-item filter-smart-energy-industrial">
                <div class="row text-center">
                ...
                <section class="about">
                    <div class="aos-init aos-animate" data-aos="fade-up">
                        <div class="row">
                            ...
                            <div class="col-lg-3 pt-4 pt-lg-0 order-2 order-lg-1 content aos-init aos-animate" >
                                <div class="text-center">
        ...
        <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-item filter-retail">
                <h3>Retail / Consumer Goods</h3>
                <section class="about">
                    <div class="container aos-init aos-animate" data-aos="fade-up">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 pt-4 pt-lg-0 order-2 order-lg-1 content aos-init aos-animate" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 pt-4 pt-lg-0 order-2 order-lg-1 content aos-init aos-animate text-center" data-aos="fade-right" data-aos-delay="100">
                                <div class="left">
        ...
        <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-item filter-home">
